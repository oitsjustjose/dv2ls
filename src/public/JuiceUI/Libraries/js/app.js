...
const toggleDisplayMode = () => {
    if (currentDisplayMode == 'dark') {
        ...
        document.getElementById('themekit-css').href = '/JuiceUI/Libraries/sass/themekit/main-moonlight.css';
    } else if (currentDisplayMode == 'moonlight') {
        window.localStorage.setItem('displayMode', 'light');
        currentDisplayMode = 'light';
        document.getElementById('themekit-css').href = '/JuiceUI/Libraries/sass/themekit/main-light.css';
    } else {
        window.localStorage.setItem('displayMode', 'dark');
        currentDisplayMode = 'dark';
        document.getElementById('themekit-css').href = '/JuiceUI/Libraries/sass/themekit/main-dark.css';
    }
